...
const STATUT_COLORS: Record<string, string> = {
  ...
  en_cours: 'bg-emerald-50 text-emerald-800 border border-emerald-200/60 font-semibold',
  termine:  'bg-slate-100 text-slate-700 border border-slate-200/60 font-semibold',
  annule:   'bg-rose-50 text-rose-800 border border-rose-200/60 font-semibold',
};
