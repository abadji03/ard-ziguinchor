          ...
          <article className="md:col-span-2 space-y-8">
            ...
            <div className="space-y-5 text-gray-700 leading-relaxed">
              ...
              <p>
                ...
                mission est claire : faciliter la mise en oeuvre des politiques publiques de
              ...
              <ul className="space-y-3">
                {[
                  ...
                  "Accompagner la mise en oeuvre du Plan de Développement Régional (PDR)",
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              ...
              <Link
                href="/a-propos"
                className="inline-flex items-center gap-2 border border-primary text-primary px-5 py-2.5 rounded-lg text-sm font-medium hover:bg-primary/5 transition-colors"
              >
